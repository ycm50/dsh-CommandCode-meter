...
export const DEFAULT_PROVIDER_PRICE_TABLE = {
  ...
  // Command Code Provider API 目录价($/1M tokens)。
  //
  // 背景(实战修复):本 fork 的用户把模型路由到 provider `commandcode`
  // (baseURL https://api.commandcode.ai/provider/v1),而此前价格表既没有
  // `commandcode` 这个 provider、主表也没有 `deepseek-v4.1-flash`,于是
  // providerPriceEntryFor 走到「未定价」分支返回 priced:false —— token 照记、
  // cost 恒 0,「今日费用」显示 ¥0(实测 2026-09-11:184 次调用、
  // 15.4M cacheRead 全为 0 元)。此处补齐官方目录价。
  //
  // 来源(2026-09-11 抓取):https://commandcode.ai/docs/plans/goat
  //   「Every model on the GOAT plan is listed below」表(Input / Output /
  //   Cache Read / Cache Write,媒体每 1M tokens),以及同页模型总表。
  // 模型 id 采用 Command Code Provider API 的写法(与本机 settings.yaml 中
  // llm-pi-ai 的 commandcode provider 模型 id 一致);大小写差异由
  // canonModelId 归一匹配兜住。
  //
  // 峰谷档说明:官方对 DeepSeek 系列给的是「空闲价 + peak 价」,峰时段为
  // 01–04 与 06–10 UTC(周一至周五)——与 DeepSeek 官方完全同一窗口,故直接
  // 复用 billingMode:'deepseek-peak'(会套用 config.peakWindows / peakEnabled
  // 与周末全谷价规则)。官方只公布了 peak 的输入/输出两项;缓存读峰值未公布,
  // 按官方自己给出的每一对价格都是恰好 2×(0.15→0.30、0.60→1.20、0.66→1.32、
  // 1.98→3.96)推算为 2× —— 必须显式写出,否则 completeTier 会用 cacheMiss
  // 兜底把缓存读按未命中价计费(15M cacheRead 会虚高数十倍)。
  // 顶层字段按本插件惯例取「空闲档」,peak/offPeak 为两档明细。
  commandcode: {
    models: {
      'deepseek/deepseek-v4.1-flash': {
        ...
        billingMode: 'deepseek-peak', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11',
      },
      ...
      // 视觉实验档:与 flash 同构的峰谷两档($0.22/$0.66,peak $0.44/$1.32)。
      ...
      // 以下为官方单档(flat)报价。
      'deepseek/deepseek-v4-flash-fast': { input: 0.28, cachedInput: 0.07, output: 0.56, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'moonshotai/Kimi-K3': { input: 3, cachedInput: 0.3, output: 15, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'moonshotai/Kimi-K2.7-Code': { input: 0.95, cachedInput: 0.19, output: 4, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'moonshotai/Kimi-K2.7-Code-Highspeed': { input: 1.9, cachedInput: 0.38, output: 8, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'moonshotai/Kimi-K2.6': { input: 0.95, cachedInput: 0.16, output: 4, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'moonshotai/Kimi-K2.5': { input: 0.6, cachedInput: 0.1, output: 3, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'zai-org/GLM-5.3': { input: 1.4, cachedInput: 0.26, output: 4.4, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'zai-org/GLM-5.2': { input: 1.4, cachedInput: 0.26, output: 4.4, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'zai-org/GLM-5.2-Fast': { input: 3, cachedInput: 0.5, output: 10.25, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'zai-org/GLM-5.1': { input: 1.4, cachedInput: 0.26, output: 4.4, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'zai-org/GLM-5': { input: 1, cachedInput: 0.2, output: 3.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'z-ai/glm-5.3-flash': { input: 0.15, cachedInput: 0.03, output: 0.5, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      // MiniMax M3 官方标注 -50% 促销价($0.60/$2.40/$0.12 挂牌 → 折后 $0.30/$1.20/$0.06)。
      'MiniMaxAI/MiniMax-M3': { input: 0.3, cachedInput: 0.06, output: 1.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11', notes: '官方 -50% 促销价;挂牌价 $0.60/$2.40/$0.12' },
      'MiniMaxAI/MiniMax-M2.7': { input: 0.3, cachedInput: 0.06, output: 1.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'MiniMaxAI/MiniMax-M2.5': { input: 0.3, cachedInput: 0.03, output: 1.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      // MiMo 官方标注 -98%/-99% 促销价。
      'xiaomi/mimo-v2.5': { input: 0.14, cachedInput: 0.0028, output: 0.28, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11', notes: '官方 -98% 促销价;挂牌价 $0.80/$4.00/$0.16' },
      'xiaomi/mimo-v2.5-pro': { input: 0.435, cachedInput: 0.0036, output: 0.87, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11', notes: '官方 -99% 促销价;挂牌价 $2.00/$6.00/$0.40' },
      'Qwen/Qwen3.8-Max-0902': { input: 2, cachedInput: 0.25, output: 6, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.8-Max': { input: 2, cachedInput: 0.25, output: 6, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.8-27B': { input: 0.4, cachedInput: 0.04, output: 3, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.8-Flash': { input: 0.16, cachedInput: 0.016, output: 0.47, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.7-Max': { input: 2.5, cachedInput: 0.5, output: 7.5, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.7-Plus': { input: 0.4, cachedInput: 0.08, output: 1.6, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.7-Flash': { input: 0.03, cachedInput: 0.006, output: 0.13, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.6-Max-Preview': { input: 1.3, cachedInput: 0.26, output: 7.8, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'Qwen/Qwen3.6-Plus': { input: 0.5, cachedInput: 0.1, output: 3, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'tencent/hy3-paid': { input: 0.14, cachedInput: 0.035, output: 0.58, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'tencent/hy4-preview': { input: 0.834, cachedInput: 0.042, output: 2.501, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'google/gemini-3.8-flash': { input: 1.5, cachedInput: 0.15, output: 7.5, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'google/gemini-3.7-flash': { input: 1.5, cachedInput: 0.15, output: 7.5, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'xai/grok-4.5': { input: 2, cachedInput: 0.5, output: 6, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'xai/grok-4.6': { input: 2, cachedInput: 0.5, output: 6, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'meta/muse-spark-1.2': { input: 1.25, cachedInput: 0.15, output: 4.25, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'meta/muse-spark-1.2-contributor': { input: 0.1, cachedInput: 0.002, output: 0.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'meta/muse-spark-1.3': { input: 1.25, cachedInput: 0.15, output: 4.25, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'meta/muse-spark-1.3-contributor': { input: 0.1, cachedInput: 0.002, output: 0.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'nvidia/nemotron-3-ultra-550b-a55b': { input: 0.6, cachedInput: 0.12, output: 2.4, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'thinkingmachines/inkling': { input: 1, cachedInput: 0.17, output: 4.05, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'thinkingmachines/inkling-small': { input: 0.5, cachedInput: 0.1, output: 1.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'stepfun/Step-3.7-Flash': { input: 0.2, cachedInput: 0.04, output: 1.15, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'stepfun/Step-3.5-Flash': { input: 0.1, cachedInput: 0.02, output: 0.3, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'gpt-5.6-sol': { input: 5, cachedInput: 0.5, output: 30, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      'gpt-5.6-luna': { input: 0.2, cachedInput: 0.02, output: 1.2, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11' },
      // 免费模型(官方标注 free,用量不扣 credits):显式标零价而非未定价,
      // 语义是「确定不花钱」而不是「不知道多少钱」。
      'meituan/LongCat-2.0:free': { input: 0, cachedInput: 0, output: 0, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11', notes: '官方免费模型,不消耗 credits' },
      'poolside/laguna-s-2.1-free': { input: 0, cachedInput: 0, output: 0, billingMode: 'flat', sourceUrl: 'https://commandcode.ai/docs/plans/goat', checkedAt: '2026-09-11', notes: '官方免费模型,不消耗 credits' },
    },
  },
}
...
export const PROVIDER_MODEL_FAMILIES = {
  ...
  // Command Code Provider API 目录(设置页拓展价格表按家族分组展示)。
  commandcode: {
    'deepseek/deepseek-v4.1-flash': 'DeepSeek V4',
    'deepseek/deepseek-v4-flash': 'DeepSeek V4',
    'deepseek/deepseek-v4-pro': 'DeepSeek V4',
    'deepseek/deepseek-v4-flash-vision-exp': 'DeepSeek V4',
    'deepseek/deepseek-v4-flash-fast': 'DeepSeek V4',
    'moonshotai/Kimi-K3': 'Kimi', 'moonshotai/Kimi-K2.7-Code': 'Kimi',
    'moonshotai/Kimi-K2.7-Code-Highspeed': 'Kimi', 'moonshotai/Kimi-K2.6': 'Kimi', 'moonshotai/Kimi-K2.5': 'Kimi',
    'zai-org/GLM-5.3': 'GLM', 'zai-org/GLM-5.2': 'GLM', 'zai-org/GLM-5.2-Fast': 'GLM',
    'zai-org/GLM-5.1': 'GLM', 'zai-org/GLM-5': 'GLM', 'z-ai/glm-5.3-flash': 'GLM',
    'MiniMaxAI/MiniMax-M3': 'MiniMax', 'MiniMaxAI/MiniMax-M2.7': 'MiniMax', 'MiniMaxAI/MiniMax-M2.5': 'MiniMax',
    'xiaomi/mimo-v2.5': 'MiMo', 'xiaomi/mimo-v2.5-pro': 'MiMo',
    'Qwen/Qwen3.8-Max-0902': 'Qwen', 'Qwen/Qwen3.8-Max': 'Qwen', 'Qwen/Qwen3.8-27B': 'Qwen',
    'Qwen/Qwen3.8-Flash': 'Qwen', 'Qwen/Qwen3.7-Max': 'Qwen', 'Qwen/Qwen3.7-Plus': 'Qwen',
    'Qwen/Qwen3.7-Flash': 'Qwen', 'Qwen/Qwen3.6-Max-Preview': 'Qwen', 'Qwen/Qwen3.6-Plus': 'Qwen',
    'tencent/hy3-paid': 'Hy3', 'tencent/hy4-preview': 'Hy4',
    'google/gemini-3.8-flash': 'Gemini', 'google/gemini-3.7-flash': 'Gemini',
    'xai/grok-4.5': 'Grok', 'xai/grok-4.6': 'Grok',
    'meta/muse-spark-1.2': 'Muse Spark', 'meta/muse-spark-1.2-contributor': 'Muse Spark',
    'meta/muse-spark-1.3': 'Muse Spark', 'meta/muse-spark-1.3-contributor': 'Muse Spark',
    'nvidia/nemotron-3-ultra-550b-a55b': 'Nemotron',
    'thinkingmachines/inkling': 'Inkling', 'thinkingmachines/inkling-small': 'Inkling',
    'stepfun/Step-3.7-Flash': 'Step', 'stepfun/Step-3.5-Flash': 'Step',
    'gpt-5.6-sol': 'GPT', 'gpt-5.6-luna': 'GPT',
    'meituan/LongCat-2.0:free': 'LongCat', 'poolside/laguna-s-2.1-free': 'Laguna',
  },
}
